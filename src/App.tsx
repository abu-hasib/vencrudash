...
function Dashboard() {
  return (
    <main className="bg-[#F9FAFB] mt-8 px-4 py-8 w-full flex flex-col gap-6">
      <HeaderSection />
      <section>
      ...
      <section>
        ...
        <div className="flex gap-2 items-start">
          <input type="radio" name="alternative" id="alternative" />
      ...
      <section>
        ...
        <div className="flex py-2 gap-2 items-center">
          ...
          <p className="text-[#667085] text-sm font-medium">Add new payment method</p>
        </div>
      </section>
    </main>
  );
